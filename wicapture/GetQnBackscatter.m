...
% % % INPUT:
% X: input matrix to the MUSIC algorithm 
% EigDiffCutoff: is used to detremine number of paths. If difference between successive eigenvalues is less than EigDiffCutoff, the particualr eigenvalue demarcates between signal and noise subspace
% nComps: [] if you want to use EigDiffCutoff to determine number of paths. Else, input nComps which is number of paths
% % % OUTPUT:
