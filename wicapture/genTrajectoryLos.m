...
for iExpOffset = 1:98
load(sprintf('../wicaptureData/losData/los%d.mat',iExpOffset), 'trajOvrSync', 'csi_trace_all', 'csi_trace_disp_all', 'nSegments', 'segStart', 'segEnd', ...
...
save(sprintf('../wicaptureData/resultData/los_trajOvrWiFi%d.mat',iExpOffset))
