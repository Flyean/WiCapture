...
./wicapture/genTrajectoryLos.m generates the trajectories estimated by WiCapture, the data that is plotted in the above CDF plot. The code is tested in MATLAB R2014b and uses CVX (http://cvxr.com/cvx/).
